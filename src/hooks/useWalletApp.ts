...
function readableErrorMessage(err: unknown) {
  ...
  if (
    ...
    return "Something went wrong while updating your local wallet data.";
  }

  if (lowerMessage.includes("not found")) {
    return "That item could not be found. Refresh the page and try again.";
  }
...
export function useWalletApp(enabled = true) {
...
const [accountName, setAccountName] = useState("");
  ...
  async function createTransaction(event: FormEvent<HTMLFormElement>) {
    ...
    if (amountMinor === null) {
      ...
      showWarning("Enter a transaction amount greater than 0.");
  ...
  async function archiveAccount(id: string) {
    if (!window.confirm("Archive this account? Existing transactions will stay unchanged.")) {
      return;
    }
  ...
  async function archiveCategory(id: string) {
    if (!window.confirm("Archive this category? Existing transactions will stay unchanged.")) {
      return;
    }
  ...
  async function createBudget(event: FormEvent<HTMLFormElement>) {
    ...
    if (amountMinor === null) {
      ...
      showWarning("Enter a budget amount greater than 0.");
  ...
  async function updateBudget(
    ...
    try {
      ...
      showSuccess("Monthly budget updated.");
  ...
  async function archiveBudget(id: string) {
    if (!window.confirm("Archive this monthly budget?")) {
      return;
    }
  ...
  async function createSavingsGoal(event: FormEvent<HTMLFormElement>) {
    ...
    if (targetAmountMinor === null) {
      ...
      showWarning("Enter a savings goal target amount greater than 0.");
    ...
    if (currentAmountMinor === null) {
      ...
      showWarning("Enter a current amount of 0 or greater.");
  ...
  async function archiveSavingsGoal(id: string) {
    if (!window.confirm("Archive this savings goal?")) {
      return;
    }
  ...
  async function contributeToSavingsGoal(goal: SavingsGoal) {
    ...
    if (amountMinor === null) {
      ...
      showWarning("Enter a contribution amount greater than 0.");
    ...
    try {
      ...
      showSuccess("Savings contribution recorded.");
  ...
  async function createRecurringBill(event: FormEvent<HTMLFormElement>) {
    ...
    if (amountMinor === null) {
      ...
      showWarning("Enter a recurring bill amount greater than 0.");
    ...
    try {
      ...
      showSuccess("Recurring bill added.");
  ...
  async function updateRecurringBill(
    ...
    try {
      ...
      showSuccess("Recurring bill updated.");
  ...
  async function archiveRecurringBill(id: string) {
    if (!window.confirm("Archive this recurring bill?")) {
      return;
    }
  ...
  async function markRecurringBillPaid(id: string) {
    ...
    try {
      ...
      showSuccess("Recurring bill marked paid.");
